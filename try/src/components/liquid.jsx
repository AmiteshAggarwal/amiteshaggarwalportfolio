...
export default function LiquidEther({
  ...
  // Add the children prop to the destructuring list
  children
}) {
  ...
  useEffect(() => {
    ...
    class WebGLManager {
      ...
      init() {
        this.props.$wrapper.append(Common.renderer.domElement); // Append after children
        Common.renderer.domElement.style.position = 'absolute'; // Position for layering
        Common.renderer.domElement.style.top = '0';
        Common.renderer.domElement.style.left = '0';
        Common.renderer.domElement.style.width = '100%';
        Common.renderer.domElement.style.height = '100%';
        // Set transparent background to allow DOM to show through
        Common.renderer.setClearColor(0x000000, 0); // Alpha 0 for transparency
