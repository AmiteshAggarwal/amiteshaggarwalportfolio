  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-purple-950 to-gray-950 flex flex-col items-center justify-center text-center px-4">
      ...
      <div className="space-y-4 mb-12">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-tight">Crafting Ideas Into </h1>
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-tight">Games & Apps </h1>
